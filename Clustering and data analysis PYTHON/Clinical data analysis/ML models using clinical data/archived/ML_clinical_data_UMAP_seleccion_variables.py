...
OUTPUT_DIR = "Results_clustering_UMAP_seleccion_variables"
...
metadata_cols_to_keep = [
    'Menopausal Status', 'Cancer Type', 'ER', 'PR', 'HER2', 'Subtype', 'Genetic Ancestry','Survival Status','Sex'
]
...
descriptores_alta_res = [
    'Menopausal Status', 'Cancer Type', 'ER', 'PR', 'HER2', 'Subtype', 'Genetic Ancestry','Race'
]
