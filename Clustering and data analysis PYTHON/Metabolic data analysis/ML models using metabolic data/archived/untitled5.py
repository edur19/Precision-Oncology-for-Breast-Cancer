...
OUT_DIR = "resultados_normas_pareto_UMAP_metricasnuevas" # Directorio de salida actualizado
...
def compute_pareto_extra_metrics(df):
    ...
    # 2️⃣ Volumen / Área del frente (si hay suficientes puntos)
...
if PARETO_LOADED:
    ...
    feature_cols = feature_cols_normas + feature_cols_pareto + feature_cols_pareto_extra
